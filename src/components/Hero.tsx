    ...
    <section id="home" className="relative overflow-hidden pt-32 pb-20 sm:pt-40 sm:pb-28">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-14 px-5 sm:px-8 lg:grid-cols-2 lg:gap-10 lg:px-10">
        <div>
          ...
          <div
            className={`mt-6 inline-flex items-center gap-2.5 rounded-full bg-ink px-5 py-2.5 ${fade("delay-300")}`}
          >
          ...
          <div className={`mt-8 flex flex-wrap items-center gap-4 ${fade("delay-500")}`}>
            <BookingTrigger className="inline-flex items-center gap-2 rounded-full bg-ink px-7 py-3.5 text-sm font-medium text-cream shadow-sm transition-colors hover:bg-gold-dark sm:text-base">
          ...
          <div className={`mt-8 flex flex-wrap items-center gap-x-8 gap-y-3 text-sm text-ink/70 ${fade("delay-500")}`}>
        ...
        <div className={`relative ${fade("delay-150")}`}>
